...
public class Encrypt {
    ...
    private String gammingString(String message, String gamma) { // гаммирование строки
    ...
    private String shiftString(Directions direct, int bits, String message) { // битовый сдвиг
    ...
    private String messageToBinar(String message) { // сообщение в бинарную строку
        String binar = "";
        for (int i = 0; i < message.length(); i++) {
    ...
    private String binaryToString(String binary) { // бинарную строку в сообщение
        String word = "";
        String message = "";
    ...
    public String unEncrypt() { // расшифровка
