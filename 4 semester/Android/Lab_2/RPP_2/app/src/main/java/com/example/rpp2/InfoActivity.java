...
import com.example.rpp2.adapters.CustomListAdapter;
import com.example.rpp2.adapters.CustomPageAdapter;
import com.example.rpp2.dao.Technology;
...
public class InfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final CustomPageAdapter customPageAdapter = new CustomPageAdapter(technologies, this);
        final ListAdapter adapter = new CustomListAdapter(this, technologies);
