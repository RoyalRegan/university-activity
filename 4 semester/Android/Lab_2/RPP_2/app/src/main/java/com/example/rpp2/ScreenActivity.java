                ...
                if (response.body() != null) {
                    ...
                    try {
                        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                            ...
                            ActivityCompat.requestPermissions(ScreenActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, premisions);
                            if(premisions==PackageManager.PERMISSION_GRANTED) {
